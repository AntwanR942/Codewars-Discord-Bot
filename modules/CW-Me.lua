...
CommandManager.Command("info", function(Args, Payload)
    SimpleEmbed(Payload, [[
        ...
        This bot is completely open source and can be found on my GitHub [here](https://github.com/AntwanR942/Codewars-Discord-Bot) along with my other programming ventures.
